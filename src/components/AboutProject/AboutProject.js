    ...
    return (
        <section className="about-project">
            ...
            <div className="about-project__content">
                <div className="about-project__stage-table">
            ...
            <div className="about-project__time-table">
                <div className="about-project__table-item about-project__table-item_green ">
                    <h3 className="time-table__title">1 неделя</h3>
                </div>
                <div className="about-project__table-item about-project__table-item_grey">
